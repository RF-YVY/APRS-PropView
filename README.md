...
Version 1.5.2.1 fixes APRS weather packet detection/transmit formatting, adds alert destination test messages, respects configured digipeater aliases, adds WXnow.txt current conditions, and shows transmitted packets in the packet list.
